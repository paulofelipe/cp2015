...
In section 5.1, Caliendo and Parro (2015) consider zero aggregate deficits in the baseline and counterfactual scenarios. To do this, we change the `D_bln` and `D_cfl` columns of the `deficit` data.frame to zero. 
...
With the data ready, just use the `run_cp2015()` function to calculate the results. Use `help(run_cp2015)` to see more details about this function. 
...
results$welfare %>%
  ...
  kable(
    format = "html",
    digits = 2,
    col.names = c("Country", "Terms of trade", "Volume of trade", "Total", "Real wages"),
